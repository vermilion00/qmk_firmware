...
#if DICTIONARY_SIZE > UINT16_MAX && defined(__AVR__)
 ...
 */
__attribute__((weak)) bool process_autocorrect_user(uint16_t *keycode, keyrecord_t *record, uint8_t *typo_buffer_size,
                                                    uint8_t *mods) {
 ...
 */
bool process_record_autocorrect(uint16_t keycode, keyrecord_t *record) {
