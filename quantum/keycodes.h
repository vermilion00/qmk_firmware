...
// Keycodes
    ...
    AM_CALIBRATE = 0x7920,
    AM_CALIBRATE_TOP = 0x7921,
    AM_PRINT_CALIBRATION = 0x7922,
    AM_LOCK_PROFILE = 0x7923,
    AM_TOGGLE_PRIORITY = 0x7924,
    AM_CLEAR_CALIBRATION = 0x7925,
    ...
    JS_RIGHT_POSITIVE_Y = 0x7948,
    JS_RIGHT_NEGATIVE_Y = 0x7949,
...
#define IS_ANALOG_MATRIX_KEYCODE(code) ((code) >= AM_CALIBRATE && (code) <= AM_CLEAR_CALIBRATION)
...
#define ANALOG_MATRIX_KEYCODE_RANGE         AM_CALIBRATE ... AM_CLEAR_CALIBRATION
