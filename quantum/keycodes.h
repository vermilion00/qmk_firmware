...
// Ranges
    ...
    AM_PROFILE_RANGE_MAX           = 0x790F,
    AM_KEYCODE_RANGE               = 0x7910,
    AM_KEYCODE_RANGE_MAX           = 0x792F,
    AM_JOYSTICK_RANGE              = 0x7930,
    AM_JOYSTICK_RANGE_MAX          = 0x793B,
    QK_QUANTUM                     = 0x7C00,
...
// Keycodes
    ...
    AM_CALIBRATE = 0x7910,
    AM_CALIBRATE_TOP = 0x7911,
    AM_PRINT_CALIBRATION = 0x7912,
    AM_LOCK_PROFILE = 0x7913,
    AM_TOGGLE_PRIORITY = 0x7914,
    AM_CLEAR_CALIBRATION = 0x7915,
    AM_INCREMENT_PROFILE = 0x7916,
    AM_DECREMENT_PROFILE = 0x7917,
    JS_LEFT_POSITIVE_X = 0x7930,
    JS_LEFT_NEGATIVE_X = 0x7931,
    JS_LEFT_NEGATIVE_Y = 0x7932,
    JS_LEFT_POSITIVE_Y = 0x7933,
    JS_LEFT_POSITIVE_Z = 0x7934,
    JS_LEFT_NEGATIVE_Z = 0x7935,
    JS_RIGHT_POSITIVE_X = 0x7936,
    JS_RIGHT_NEGATIVE_X = 0x7937,
    JS_RIGHT_POSITIVE_Y = 0x7938,
    JS_RIGHT_NEGATIVE_Y = 0x7939,
    JS_RIGHT_POSITIVE_Z = 0x793A,
    JS_RIGHT_NEGATIVE_Z = 0x793B,
...
// Alias
    ...
    AM_CLTP    = AM_CALIBRATE_TOP,
    AM_PRNT    = AM_PRINT_CALIBRATION,
    AM_LOCK    = AM_LOCK_PROFILE,
    AM_TGPR    = AM_TOGGLE_PRIORITY,
    AM_CLCL    = AM_CLEAR_CALIBRATION,
    AM_INPR    = AM_INCREMENT_PROFILE,
    AM_PRPL    = AM_INCREMENT_PROFILE,
    AM_DEPR    = AM_DECREMENT_PROFILE,
    AM_PRMN    = AM_DECREMENT_PROFILE,
    JS_LPX     = JS_LEFT_POSITIVE_X,
    JS_LSR     = JS_LEFT_POSITIVE_X,
    JS_LNX     = JS_LEFT_NEGATIVE_X,
    JS_LSL     = JS_LEFT_NEGATIVE_X,
    JS_LNY     = JS_LEFT_NEGATIVE_Y,
    JS_LSD     = JS_LEFT_NEGATIVE_Y,
    JS_LPY     = JS_LEFT_POSITIVE_Y,
    JS_LSU     = JS_LEFT_POSITIVE_Y,
    JS_LPZ     = JS_LEFT_POSITIVE_Z,
    JS_LNZ     = JS_LEFT_NEGATIVE_Z,
    JS_RPX     = JS_RIGHT_POSITIVE_X,
    JS_RSR     = JS_RIGHT_POSITIVE_X,
    JS_RNX     = JS_RIGHT_NEGATIVE_X,
    JS_RSL     = JS_RIGHT_NEGATIVE_X,
    JS_RPY     = JS_RIGHT_POSITIVE_Y,
    JS_RSU     = JS_RIGHT_POSITIVE_Y,
    JS_RNY     = JS_RIGHT_NEGATIVE_Y,
    JS_RSD     = JS_RIGHT_NEGATIVE_Y,
...
#define IS_ANALOG_MATRIX_KEYCODE(code) ((code) >= AM_CALIBRATE && (code) <= AM_DECREMENT_PROFILE)
...
#define ANALOG_MATRIX_KEYCODE_RANGE         AM_CALIBRATE ... AM_DECREMENT_PROFILE
